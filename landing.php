...
<section id="how-to-use" class="section fade-in">
    ...
    <div class="steps-container">
        <div class="step-card">
            ...
            <div class="step-content">
                ...
                <p>Create an account or log in using your credentials.</p>
            </div>
        </div>
        ...
        <div class="step-card">
            ...
            <div class="step-content">
                ...
                <p>Choose a service and complete the form.</p>
            </div>
        </div>
    ...
    <div class="step-content">
        ...
        <p>Track your request documents using your account.</p>
    </div>
</div>
    ...
    <div class="step-content">
        ...
        <p>You may pick up your document once you see you request status is accepted.</p>
    </div>
</div>
...
function setupSearchEnhancements() {
    ...
    searchInput.placeholder = "Enter complete name (e.g., Harold Tulod)...";
