...
<div class="sidebar text-white p-3">
    ...
    <ul class="nav flex-column">
        <li class="nav-item mb-3" style="margin-top: 30px;">
            <a href="dashboard.html" class="nav-link text-white d-flex align-items-center sidebar-item">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <h3 class="fw-bold">
                        ...
                        // Query to count total document requests
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <h3 class="fw-bold">
                        ...
                        // Query to count pending document requests
        ...
        <div class="card-body">                             
            <div class="d-flex justify-content-between align-items-center">                                 
                <div>                                     
                    ...
                    <h3 class="fw-bold">
                        <?php
                        // Database connection for announcements
                        $servername = "localhost";
                        $username = "root";
                        $password = "";
                        $database = "barangay";
...
// Also initialize when tab is shown (for Bootstrap tabs)
